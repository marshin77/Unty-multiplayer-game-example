...
{
    /// <summary>
    /// Custom network connection used to support WebGL in the master server.
    /// </summary>
    public class MasterServerWebGLCustomNetworkConnection : NetworkConnection
    {
        private int offset;
        ...
        {
            return NetworkTransport.Send(MasterServer.webGLHostId, connectionId - offset, channelId, bytes, numBytes, out error);
        }
    }
}